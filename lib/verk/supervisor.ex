defmodule Verk.Supervisor do
  ...
  * A `Verk.Queue.Supervisor` per queue
  ...
  def init(_) do
    ...
    verk_node_id     = Application.get_env(:verk, :node_id, generate_node_id())
    ...
    children = [redis, node_manager, event_producer, queue_stats, schedule_manager, manager_sup, drainer]
